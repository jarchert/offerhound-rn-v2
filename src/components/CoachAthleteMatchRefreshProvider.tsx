...
export function CoachAthleteMatchRefreshProvider(_props: any) {
  return (
    <View style={s.container}>
      <Text style={s.text}>[CoachAthleteMatchRefreshProvider]</Text>
      <Text style={s.hint}>Scaffold — port from Ch.13</Text>
    </View>
  );
}

export default CoachAthleteMatchRefreshProvider;
